            ...
            <div className="grid max-w-md gap-10 row-gap-5 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto">
                ...
                <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
                    <div className="text-center">
                        <div className="text-lg font-semibold">SIMPLE</div>
                        <div className="flex items-center justify-center mt-2">
                            <div className="mr-1 text-5xl font-bold">39 dt</div>
                            <div className="text-gray-700">/ mois </div>
                        </div>
                        <div className="mt-2 space-y-3">
                            <div className="text-gray-700">Feature detail</div>
                            <div className="text-gray-700">Feature detail</div>
                            <div className="text-gray-700">Feature detail</div>
                        </div>
                    </div>
                ...
                <div className="relative flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow border-indigo-700">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center mt-2">
                            <div className="mr-1 text-5xl font-bold">79 dt</div>
                            <div className="text-gray-700">/ mois </div>
                        </div>
                        <div className="mt-2 space-y-3">
                            <div className="text-gray-700">Feature detail</div>
                ...
                <div className="flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border rounded shadow-sm sm:items-center hover:shadow">
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center mt-2">
                            <div className="mr-1 text-5xl font-bold">59 dt</div>
                            <div className="text-gray-700">/ mois </div>
                        </div>
                        <div className="mt-2 space-y-3">
                            <div className="text-gray-700">Feature detail</div>
