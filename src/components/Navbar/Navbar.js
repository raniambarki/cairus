      ...
      <div class="relative flex items-center justify-between">
          ...
          {navigation.map((item) => (
            <li>
              <a
                ...
                title={item.name}
                class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-indigo-700"
              >
                {item.name}
              </a>
            </li>
        ...
        <div class="lg:hidden">
          <button
            ...
            title="Open Menu"
            class="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline hover:bg-indigo-100 focus:bg-indigo-100 "
